...
all_regressions <- modelsummary(models = list(
  "Democrats Only" = ols.dem.nov,
  "Republicans Only" = ols.rep.nov,
  "All Candidates" = ols.all.nov), output = "markdown")
...
knitr::kable(top10_polls, digits = 2, col.names = c("Year", "Party", "Candidate", "Two-Party Vote Share", "Final Poll Prediction of Vote Share", "Prediction Error"), align = 'c')
```
