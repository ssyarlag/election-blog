...
setwd("/Users/shriyayarlagadda/Desktop/Election-Blog/content/post/2024-10-02-week-5-demographics")
...
anes <- read_csv("data/anes_2016.csv") # Total ANES Cumulative Data File. 
