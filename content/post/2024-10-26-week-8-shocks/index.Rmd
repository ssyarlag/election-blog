...
# Read shocks data
d_sc_prec <- read_csv("supreme_court_precedents.csv")
...
# (3)  = Snakecase + prediction for confidence interval
...
```{r echo = FALSE, message = FALSE, warning = FALSE}
# Out-of-Sample testing of models without the federal grant allocation variable
...
test |>
  ...
  knitr::kable(col.names = c("State", "Predicted Winner", "Democratic Vote Share", "Low Pred", "High Pred"), align = "c", digits = 2, caption = "Prediction (Post 1984 Data)")
...
Finally, I am interested in testing the effect of the overturning of Supreme Court precedent on mobilization. In particular, I believe that there would be a strong effect on Democratic voter outcomes as the values interact with h

# References

1.  Julia. 2020. “Answer to ‘Export R Data to Csv.’” *Stack Overflow*. <https://stackoverflow.com/a/62017887>.; Bobbitt, Zach. 2023. “How to Convert Datetime to Date in R.” Statology. January 25, 2023. <https://www.statology.org/r-convert-datetime-to-date/>. GKi. 2023. “Answer to ‘Extract Month and Year From Date in R.’” *Stack Overflow*. <https://stackoverflow.com/a/76709941>. rafa.pereira. 2016. “Answer to ‘Extract Month and Year From Date in R.’” *Stack Overflow*. <https://stackoverflow.com/a/37704385>.; “Extract the Last N Characters from String in R - Spark By {Examples}.” n.d. Accessed October 26, 2024. <https://sparkbyexamples.com/r-programming/extract-the-last-n-characters-from-string-in-r/>.
...
Data sources for state and county-level turnout and Supreme Court cases are unknown, but were generously provided by the GOV 1372 course staff
