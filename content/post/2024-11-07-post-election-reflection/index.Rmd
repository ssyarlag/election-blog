...
knitr::kable(coefplot, col.names = c("Coefficient", "OLS", "Elastic-Net"), align = "c", digits = 4)
```
...
final_preds |>
  ...
  knitr::kable(col.names = c("State", "Predicted Vote Share - Harris", "Predicted Vote Share - Trump", "Winner"), align = "c")
```
...
final_preds |>
  ...
  knitr::kable(col.names = c("Harris", "Trump"))
```
...
# Mean Absolute Error (Thank you to Matt Dardet for the code!)
dem_ae <- mean(abs(final_error$D_pv - final_error$final_pred), na.rm = TRUE)
rep_ae <- mean(abs(final_error$R_pv - final_error$final_pred_rep), na.rm = TRUE)

tibble_row("Dem. Mean AE" = dem_ae, "Rep. Mean AE" = rep_ae) |>
  knitr::kable(align = "c")
